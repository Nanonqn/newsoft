...
use common\models\Monitores;

/**
 * MonitoresSearch represents the model behind the search form about `common\models\Monitores`.
 */
class MonitoresSearch extends Monitores
{
    ...
    {
        return [
            [['id', 'proveedores_id', 'marcas_id'], 'integer'],
