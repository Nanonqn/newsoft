...
class TipoUsuarioSearch extends TipoUsuario
{
    ...
    {
        return [
            [['id', 'valorTipoUsuario'], 'integer'],
            [['nombreTipoUsuario'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            'id' => $this->id,
            'valorTipoUsuario' => $this->valorTipoUsuario,
        ]);

        $query->andFilterWhere(['like', 'nombreTipoUsuario', $this->nombreTipoUsuario]);
